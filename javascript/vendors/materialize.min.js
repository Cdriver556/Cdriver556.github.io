...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
                                ...
                                if (o(T)) {
                                    ...
                                    for (var O in C)
                                        if ("element" !== O) {
                                            ...
                                            if (E.currentValue = A, "tween" === O) g = A;
                                            else {
                                                if (x.Hooks.registered[O]) {
                                                    var V = x.Hooks.getRoot(O),
                                                        I = o(T).rootPropertyValueCache[V];
                                                    I && (E.rootPropertyValue = I)
                                                }
                                                var _ = x.setPropertyValue(T, O, E.currentValue + (0 === parseFloat(A) ? "" : E.unitType), E.rootPropertyValue, E.scrollData);
                                                x.Hooks.registered[O] && (o(T).rootPropertyValueCache[V] = x.Normalizations.registered[V] ? x.Normalizations.registered[V]("extract", null, _[1]) : _[1]), "transform" === _[0] && (S = !0)
                                            }
                                        }
                ...
                function a() {
                    function t(t) {
                        ...
                        function m() {
                            ...
                            var s = 100,
                                l = {};
                            if (a && n) l.emToPx = _.lastEmToPx, l.percentToPxWidth = _.lastPercentToPxWidth, l.percentToPxHeight = _.lastPercentToPxHeight;
                            else {
                                ...
                                }), b.CSS.setPropertyValue(u, "paddingLeft", s + "em"), l.percentToPxWidth = _.lastPercentToPxWidth = (parseFloat(x.getPropertyValue(u, "width", null, !0)) || 1) / s, l.percentToPxHeight = _.lastPercentToPxHeight = (parseFloat(x.getPropertyValue(u, "height", null, !0)) || 1) / s, l.emToPx = _.lastEmToPx = (parseFloat(x.getPropertyValue(u, "paddingLeft")) || 1) / s, t.myParent.removeChild(u)
                            }
                            return null === _.remToPx && (_.remToPx = parseFloat(x.getPropertyValue(i.body, "fontSize")) || 16), null === _.vwToPx && (_.vwToPx = parseFloat(e.innerWidth) / 100, _.vhToPx = parseFloat(e.innerHeight) / 100), l.remToPx = _.remToPx, l.vwToPx = _.vwToPx, l.vhToPx = _.vhToPx, b.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), r), l
                        }
                        if (s.begin && 0 === T) try {
                            s.begin.call(h, h)
                        } catch (w) {
                        ...
                        if ("scroll" === A) {
                            ...
                            for (var V in M)
                                if ("element" !== V) {
                                    ...
                                    M[V].startValue = M[V].currentValue = M[V].endValue, M[V].endValue = I, v.isEmptyObject(y) || (M[V].easing = s.easing), b.debug && console.log("reverse tweensContainer (" + V + "): " + JSON.stringify(M[V]), r)
                                }
                            l = M
                        } else if ("start" === A) {
                            var M;
                            ...
                            for (var D in g) {
                                ...
                                if (o(r).isSVG || "tween" === $ || x.Names.prefixCheck($)[1] !== !1 || x.Normalizations.registered[$] !== n) {
                                    (s.display !== n && null !== s.display && "none" !== s.display || s.visibility !== n && "hidden" !== s.visibility) && /opacity|filter/.test(D) && !N && 0 !== Q && (N = 0), s._cacheValues && M && M[D] ? (N === n && (N = M[D].endValue + M[D].unitType), F = o(r).rootPropertyValueCache[$]) : x.Hooks.registered[D] ? N === n ? (F = x.getPropertyValue(r, $), N = x.getPropertyValue(r, D, F)) : F = x.Hooks.templates[$][1] : N === n && (N = x.getPropertyValue(r, D));
                                    var W, R, H, X = !1;
                                    if (W = f(D, N), N = W[0], H = W[1], W = f(D, Q), Q = W[0].replace(/^([+-\/*])=/, function (t, e) {
                                            return X = e, ""
                                        }), R = W[1], N = parseFloat(N) || 0, Q = parseFloat(Q) || 0, "%" === R && (/^(fontSize|lineHeight)$/.test(D) ? (Q /= 100, R = "em") : /^scale/.test(D) ? (Q /= 100, R = "") : /(Red|Green|Blue)$/i.test(D) && (Q = Q / 100 * 255, R = "")), /[\/*]/.test(X)) R = H;
                                    else if (H !== R && 0 !== N)
                                        if (0 === Q) R = H;
                                        else {
                                            a = a || m();
                        ...
                        l.element && (x.Values.addClass(r, "velocity-animating"), j.push(l), "" === s.queue && (o(r).tweensContainer = l, o(r).opts = s), o(r).isAnimating = !0, T === k - 1 ? (b.State.calls.push([j, h, s, null, O.resolver]), b.State.isTicking === !1 && (b.State.isTicking = !0, c())) : T++)
                    }
                    var a, r = this,
                            ...
                            if (!p.isPlainObject(g) || v.isEmptyObject(g)) {
                                if (v.isString(g) && b.Redirects[g]) {
                                    ...
                                    return q.backwards === !0 && (h = p.extend(!0, [], h).reverse()), p.each(h, function (t, e) {
                                        parseFloat(q.stagger) ? q.delay = V + parseFloat(q.stagger) * t : v.isFunction(q.stagger) && (q.delay = V + q.stagger.call(e, t, k)), q.drag && (q.duration = parseFloat(M) || (/^(callout|transition)/.test(g) ? 1e3 : m), q.duration = Math.max(q.duration * (q.backwards ? 1 - t / k : (t + 1) / k), .75 * q.duration, 200)), b.Redirects[g].call(e, e, q || {}, t, k, h, O.promise ? O : n)
                                    }), t()
                                }
        ...
        function S(t) {
            ...
            return new(e = i ? i : mt ? L : yt ? F : gt ? R : Q)(t, P)
        }
        ...
        function P(t, e, i) {
            var n = i.pointers.length,
                ...
                r = e & Tt && 0 === n - a,
                o = e & (Pt | Ot) && 0 === n - a;
            i.isFirst = !!r, i.isFinal = !!o, r && (t.session = {}), i.eventType = e, O(t, i), t.emit("hammer.input", i), t.recognize(i), t.session.prevInput = i
        }
        ...
        function O(t, e) {
            ...
            var r = i.firstInput,
                ...
                l = e.center = M(n);
            e.timeStamp = ft(), e.deltaTime = e.timeStamp - r.timeStamp, e.angle = j(s, l), e.distance = _(s, l), A(i, e), e.offsetDirection = I(e.deltaX, e.deltaY), e.scale = o ? z(o.pointers, n) : 1, e.rotation = o ? D(o.pointers, n) : 0, E(i, e);
            var u = t.element;
        ...
        function A(t, e) {
            var i = e.center,
                ...
                a = t.prevDelta || {},
                r = t.prevInput || {};
            (e.eventType === Tt || r.eventType === Pt) && (a = t.prevDelta = {
                x: r.deltaX || 0,
                y: r.deltaY || 0
            }, n = t.offsetDelta = {
                x: i.x,
        ...
        function I(t, e) {
            return t === e ? At : pt(t) >= pt(e) ? t > 0 ? Et : qt : e > 0 ? Mt : Vt
        }
        ...
        function z(t, e) {
            return _(e[0], e[1], zt) / _(t[0], t[1], zt)
        }
        ...
        function W(t, e) {
            ...
            for (a = 0; a < o.length;) n[o[a].identifier] && s.push(o[a]), e & (Pt | Ot) && delete n[o[a].identifier], a++;
        ...
        function G(t) {
            return t == Vt ? "down" : t == Mt ? "up" : t == Et ? "left" : t == qt ? "right" : ""
        }
        ...
        t.MSPointerEvent && (Wt = "MSPointerDown", Rt = "MSPointerMove MSPointerUp MSPointerCancel"), u(L, T, {
            handler: function (t) {
                var e = this.store,
                    i = !1,
                ...
                a & Tt && (0 === t.button || o) ? 0 > s && (e.push(t), s = e.length - 1) : a & (Pt | Ot) && (i = !0), 0 > s || (e[s] = t, this.callback(this.manager, a, {
                    pointers: e,
                    changedPointers: [t],
                    pointerType: r,
                    srcEvent: t
            ...
            preventDefaults: function (t) {
                if (!Zt) {
                    ...
                    var n = this.actions,
                        ...
                        r = g(n, ne),
                        o = g(n, ie);
                    return a || r && i & It || o && i & _t ? this.preventSrc(e) : void 0
                }
            },
        ...
        Y.prototype = {
            ...
            process: function (t) {
                var e = this.state,
                    ...
                    n = e & (re | oe),
                    a = this.attrTest(t);
                return n && (i & Ot || !a) ? e | ue : n || a ? i & Pt ? e | se : e & re ? e | oe : re : ce
            }
        }), u(J, Z, {
            defaults: {
                event: "pan",
            ...
            getTouchAction: function () {
                var t = this.options.direction,
                    e = [];
                return t & It && e.push(ne), t & _t && e.push(ie), e
            },
            directionTest: function (t) {
                var e = this.options,
                    ...
                    r = t.deltaX,
                    o = t.deltaY;
                return a & e.direction || (e.direction & It ? (a = 0 === r ? At : 0 > r ? Et : qt, i = r != this.pX, n = Math.abs(t.deltaX)) : (a = 0 === o ? At : 0 > o ? Mt : Vt, i = o != this.pY, n = Math.abs(t.deltaY))), t.direction = a, i && n > e.threshold && a & e.direction
            },
            attrTest: function (t) {
            ...
            process: function (t) {
                ...
                if (this._input = t, !n || !i || t.eventType & (Pt | Ot) && !r) this.reset();
            ...
            attrTest: function (t) {
                ...
                return i & (It | _t) ? e = t.velocity : i & It ? e = t.velocityX : i & _t && (e = t.velocityY), this._super.attrTest.call(this, t) && i & t.direction && t.distance > this.options.threshold && pt(e) > this.options.velocity && t.eventType & Pt
            },
            emit: function (t) {
                var e = G(t.direction);
            ...
            init: function () {
                return this.each(function () {
                    ...
                    var i, n, a = e.find("li.tab a"),
                        ...
                        s = 0;
                    i = t(a.filter('[href="' + location.hash + '"]')), 0 === i.length && (i = t(this).find("li.tab a.active").first()), 0 === i.length && (i = t(this).find("li.tab a").first()), i.addClass("active"), s = a.index(i), 0 > s && (s = 0), n = t(i[0].hash), e.append('<div class="indicator"></div>');
                    ...
                    e.is(":visible") && (l.css({
                        ...
                        r = e.width(), o = e.find("li").first().outerWidth(), 0 > s && (s = 0), 0 !== o && 0 !== r && (l.css({
                            right: r - (s + 1) * o
                        }), l.css({
                            left: s * o
                        }))
                        ...
                        var c = s;
                        s = a.index(t(this)), 0 > s && (s = 0), n.show(), s - c >= 0 ? (l.velocity({
                            right: r - (s + 1) * o
                        }, {
                            duration: 300,
                            queue: !1,
